 ...
 */
__API__ int at_channel_write(at_agent_t *at_agent, int channel_id, uint8_t *buffer, size_t buffer_len);
 ...
 */
__API__ int at_channel_read_timed(at_agent_t *at_agent, int channel_id, uint8_t *buffer, size_t buffer_len, uint32_t timeout);
 ...
 * @retval  none -1         the number of bytes read.
 */
__API__ int at_channel_read(at_agent_t *at_agent, int channel_id, uint8_t *buffer, size_t buffer_len);
 ...
 */
__API__ int at_channel_alloc_id(at_agent_t *at_agent, int channel_id, const char *ip, const char *port);
 ...
 * @retval  none -1         the id of the channel.
 */
__API__ int at_channel_alloc(at_agent_t *at_agent, const char *ip, const char *port);
 ...
 * @retval  none -1         the id of the channel.
 */
__API__ int at_channel_alloc_with_size(at_agent_t *at_agent, const char *ip, const char *port, size_t socket_buffer_size);
 ...
 */
__API__ int at_channel_free(at_agent_t *at_agent, int channel_id);
 ...
 */
__API__ int at_channel_set_broken(at_agent_t *at_agent, int channel_id);
 ...
 */
__API__ int at_channel_is_working(at_agent_t *at_agent, int channel_id);
 ...
 */
__API__ int at_init(at_agent_t *at_agent, char *task_name, k_stack_t *stk, hal_uart_port_t uart_port, at_event_t *event_table, size_t event_table_size);
...
None
 */
__API__ void at_deinit(at_agent_t *at_agent);
 ...
 */
__API__ int at_echo_create(at_echo_t *echo, char *buffer, size_t buffer_size, char *echo_expect);
 ...
 * @retval  0               create successfully.
 */
__API__ int at_echo_fuzzy_matching_create(at_echo_t *echo, char *buffer, size_t buffer_size, char *echo_expect_contains);
 ...
 */
__API__ int at_cmd_exec(at_agent_t *at_agent, at_echo_t *echo, uint32_t timeout, const char *cmd, ...);
 ...
 * @retval  0               execute successfully.
 */
__API__ int at_cmd_exec_until(at_agent_t *at_agent, at_echo_t *echo, uint32_t timeout, const char *cmd, ...);
 ...
 * @retval  0               execute successfully.
 */
__API__ int at_raw_data_send(at_agent_t *at_agent, at_echo_t *echo, uint32_t timeout, const uint8_t *buf, size_t size);
 ...
 * @retval  0               execute successfully.
 */
__API__ int at_raw_data_send_until(at_agent_t *at_agent, at_echo_t *echo, uint32_t timeout, const uint8_t *buf, size_t size);
 ...
 * @return  None
 */
__API__ void at_uart_input_frame(at_agent_t *at_agent, uint8_t *pdata, uint16_t len);
 ...
 * @return  None
 */
__API__ void at_uart_input_byte_no_notify(at_agent_t *at_agent, uint8_t data);
#else
/**
 * @brief Write byte to the at uart.
 * The function called by the uart interrupt, to put the data from the uart to the at framework.
 ...
 * @return  None
 */
__API__ void at_uart_input_byte(at_agent_t *at_agent, uint8_t data);
#endif
/**
 ...
 */
__API__ int at_global_lock_pend(at_agent_t *at_agent);
 ...
 */
__API__ int at_global_lock_post(at_agent_t *at_agent);
 ...
 */
__API__ int at_uart_read(at_agent_t *at_agent, uint8_t *buffer, size_t buffer_len);
 ...
 * @return  length of the data read from the uart.
 */
__API__ int at_uart_readline(at_agent_t *at_agent, uint8_t *buffer, size_t buffer_len);
 ...
 * @return  length of the data read from the uart.
 */
__API__ int at_uart_drain(at_agent_t *at_agent, uint8_t *buffer, size_t buffer_len);
 ...
 */
__API__ const char *at_channel_ip_get(at_agent_t *at_agent, int channel_id);
 ...
 */
__API__ const char *at_channel_port_get(at_agent_t *at_agent, int channel_id);
