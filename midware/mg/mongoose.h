...
extern struct mg_tcpip_driver mg_tcpip_driver_ecxx;
...
struct mg_tcpip_urt {
  void *urt;                                    // urt bus descriptor
  size_t (*tcp_rx)(void *data, int len);          // urt read
  size_t (*tcp_tx)(void *data, int len);         // urt write
};
#endif
