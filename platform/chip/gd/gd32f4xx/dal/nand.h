...
u8 nand_write_page_value(u32 PageNum,u16 ColNum,u32 cval,u16 NumByteToWrite);
u8 nand_copy_page(u32 Source_PageNum,u32 Dest_PageNum);
u8 nand_read_spare(u32 PageNum,u16 ColNum,u8 *pBuffer,u16 NumByteToRead);
u8 nand_write_spare(u32 PageNum,u16 ColNum,u8 *pBuffer,u16 NumByteToRead);
