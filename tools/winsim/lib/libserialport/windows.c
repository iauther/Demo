...
static void enumerate_hub(sp_port_t *port, const char *hub_name,
...
static void enumerate_hub_ports(sp_port_t *port, HANDLE hub_device,
...
static void enumerate_host_controller(sp_port_t *port,
...
static void get_usb_details(sp_port_t *port, DEVINST dev_inst_match)
{
...
SP_PRIV enum sp_return get_port_details(sp_port_t *port)
{
	/*
...
SP_PRIV enum sp_return list_ports(sp_port_t ***list)
{
	HKEY key;
	TCHAR *value, *data;
