...
SP_PRIV sp_port_t** list_append(sp_port_t** list, const char* portname);

/* OS-specific Helper functions. */
SP_PRIV sp_return_t get_port_details(sp_port_t* port);
SP_PRIV sp_return_t list_ports(sp_port_t*** list);
 ...
 *
 * The user should allocate a variable of type "sp_port_t *" and pass a
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_port_by_name(const char *portname, sp_port_t **port_ptr);
 ...
 * @since 0.1.0
 */
SP_API void sp_free_port(sp_port_t *port);
 ...
 * "sp_port_t **" and pass a pointer to this to receive the result.
 *
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_list_ports(sp_port_t ***list_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_copy_port(const sp_port_t *port, sp_port_t **copy_ptr);
 ...
 * @since 0.1.0
 */
SP_API void sp_free_port_list(sp_port_t **ports);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_open(sp_port_t *port, enum sp_mode flags);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_close(sp_port_t *port);
 ...
 * @since 0.1.0
 */
SP_API char *sp_get_port_name(const sp_port_t *port);
 ...
 * @since 0.1.1
 */
SP_API char *sp_get_port_description(const sp_port_t *port);
 ...
 * @since 0.1.1
 */
SP_API sp_transport_t sp_get_port_transport(const sp_port_t *port);
 ...
 * @since 0.1.1
 */
SP_API sp_return_t sp_get_port_usb_bus_address(const sp_port_t *port,
 ...
 * @since 0.1.1
 */
SP_API sp_return_t sp_get_port_usb_vid_pid(const sp_port_t *port, int *usb_vid, int *usb_pid);
 ...
 * @since 0.1.1
 */
SP_API char *sp_get_port_usb_manufacturer(const sp_port_t *port);
 ...
 * @since 0.1.1
 */
SP_API char *sp_get_port_usb_product(const sp_port_t *port);
 ...
 * @since 0.1.1
 */
SP_API char *sp_get_port_usb_serial(const sp_port_t *port);
 ...
 * @since 0.1.1
 */
SP_API char *sp_get_port_bluetooth_address(const sp_port_t *port);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_port_handle(const sp_port_t *port, void *result_ptr);
 ...
 *
 * The user should allocate a variable of type "sp_config_t *" and
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_new_config(sp_config_t **config_ptr);
 ...
 * @since 0.1.0
 */
SP_API void sp_free_config(sp_config_t *config);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config(sp_port_t *port, sp_config_t *config);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config(sp_port_t *port, const sp_config_t *config);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_baudrate(sp_port_t *port, int baudrate);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_baudrate(const sp_config_t *config, int *baudrate_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_baudrate(sp_config_t*config, int baudrate);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_bits(sp_port_t *port, int bits);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_bits(const sp_config_t *config, int *bits_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_bits(sp_config_t *config, int bits);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_parity(sp_port_t *port, enum sp_parity parity);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_parity(const sp_config_t *config, sp_parity_t *parity_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_parity(sp_config_t *config, sp_parity_t parity);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_stopbits(sp_port_t *port, int stopbits);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_stopbits(const sp_config_t *config, int *stopbits_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_stopbits(sp_config_t *config, int stopbits);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_rts(sp_port_t *port, sp_rts_t rts);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_rts(const sp_config_t *config, sp_rts_t *rts_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_rts(sp_config_t*config, sp_rts_t rts);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_cts(sp_port_t *port, sp_cts_t cts);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_cts(const sp_config_t *config, sp_cts_t *cts_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_cts(sp_config_t *config, sp_cts_t cts);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_dtr(sp_port_t *port, enum sp_dtr dtr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_dtr(const sp_config_t *config, enum sp_dtr *dtr_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_dtr(sp_config_t *config, enum sp_dtr dtr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_dsr(sp_port_t *port, enum sp_dsr dsr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_dsr(const sp_config_t *config, sp_dsr_t *dsr_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_dsr(sp_config_t *config, sp_dsr_t dsr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_xon_xoff(sp_port_t *port, sp_xonxoff_t xon_xoff);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_config_xon_xoff(const sp_config_t *config, sp_xonxoff_t *xon_xoff_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_xon_xoff(sp_config_t *config, sp_xonxoff_t xon_xoff);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_config_flowcontrol(sp_config_t *config, sp_flowcontrol_t flowcontrol);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_set_flowcontrol(sp_port_t *port, sp_flowcontrol_t flowcontrol);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_blocking_read(sp_port_t *port, void *buf, size_t count, unsigned int timeout_ms);
 ...
 * @since 0.1.1
 */
SP_API sp_return_t sp_blocking_read_next(sp_port_t *port, void *buf, size_t count, unsigned int timeout_ms);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_nonblocking_read(sp_port_t *port, void *buf, size_t count);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_blocking_write(sp_port_t *port, const void *buf, size_t count, unsigned int timeout_ms);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_nonblocking_write(sp_port_t *port, const void *buf, size_t count);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_input_waiting(sp_port_t *port);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_output_waiting(sp_port_t *port);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_flush(sp_port_t *port, sp_buffer_t buffers);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_drain(sp_port_t *port);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_new_event_set(sp_event_set_t **result_ptr);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_add_port_events(sp_event_set_t *event_set,
	const sp_port_t *port, sp_event_t mask);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_wait(sp_event_set_t *event_set, unsigned int timeout_ms);
 ...
 * @since 0.1.0
 */
SP_API void sp_free_event_set(sp_event_set_t *event_set);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_get_signals(sp_port_t *port, sp_signal_t *signal_mask);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_start_break(sp_port_t *port);
 ...
 * @since 0.1.0
 */
SP_API sp_return_t sp_end_break(sp_port_t *port);
