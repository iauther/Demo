...
extern sdio_internal_status_t sdio_set_function_interrupt(hal_sdio_port_t sdio_port, hal_sdio_function_id_t function,bool is_enable);
...
hal_sdio_status_t hal_sdio_init(hal_sdio_port_t sdio_port, hal_sdio_config_t *sdio_config)
{
    ...
    msdc_nvic_set((msdc_port_t)sdio_port,false);//ian add
...
//   sdio_set_function_interrupt((msdc_port_t)sdio_port,HAL_SDIO_FUNCTION_1,true);
    /*enable sdio interrupt*/
//    msdc_sdio_interrupt_set((msdc_port_t)sdio_port,true);
    ...
    msdc_nvic_set((msdc_port_t)sdio_port,true);//ian add
